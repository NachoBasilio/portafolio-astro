  ...
  return (
    ...
    >
      <div className="titulo-proyecto grow">
        <h3 className="text-2xl m-auto pl-4 pt-2 font-bold tracking-wider">{titulo}</h3>
        <p className="text-xl mt-2 bg-zinc-100 px-4 py-2 dark:bg-zinc-800  tracking-wider">{descripcion}</p>
      </div>
      <div className="imagen-proyectos m-auto bg-zinc-100 h-60 dark:bg-zinc-800" style={divStyle}></div>
    </a>
  );
}
