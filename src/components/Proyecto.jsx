...
>
  <div className="titulo-proyecto grow  overflow-hidden transition-all duration-300">
    <h3 className="text-xl m-auto pl-4 pt-2 font-bold tracking-wider">{titulo}</h3>
    <p className="text-xl mt-2 hover:h-auto h-52 bg-zinc-100 px-4 py-2 dark:bg-zinc-800 tracking-wider">{descripcion}</p>
  </div>
